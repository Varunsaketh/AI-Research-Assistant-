...
analysis_task = Task(
    ...
    3. highlight any potential gaps or limitations in the research findings and suggest areas for further investigation.
   
    provide:
    1. A list of actionable recommendations based on your analysis, including any potential next steps
